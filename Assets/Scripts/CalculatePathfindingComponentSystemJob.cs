...
//[UpdateAfter(typeof(AIComponentMoveJobSystem))]
...
//    [BurstCompile]
//    private struct ReverseNativeEntityArray : IJob
//    {
//        public NativeArray<Entity> reverse;
...
//    [BurstCompile]
//    private struct PrepareEntityForMove : IJob
//    {
//        [ReadOnly]
//        public Entity entity;
//        [ReadOnly]
//        public NativeArray<Entity> path;
//        [ReadOnly]
//        public Tile chosenTile;
//        [ReadOnly]
//        public ComponentDataFromEntity<Tile> tileComponent; // we could simplify this by simply returning the tileInfo instead of the tile
//        [ReadOnly]
//        public ComponentType flagType;

//        public ComponentDataFromEntity<MoveTo> moveToComponent;

//        [WriteOnly]
//        public DynamicBuffer<MapBuffer> currentPathBuffer;

//        public EntityCommandBuffer entityCommandBuffer;

//        public void Execute()
//        {
//            MoveTo moveTo = moveToComponent[entity];

//            moveTo.positionInMove = 0;

//            moveToComponent[entity] = moveTo;

//            //Element 0 is always the currently occupied tile, therefore not needed
//            for (int i = 1; i < path.Length; i++)
//            {
//                Tile tileFromPath = tileComponent[path[i]];

//                //Check for duplicate tiles
//                if (tileFromPath.coordinates.Equals(tileComponent[path[i - 1]].coordinates)) { continue; }

//                //If its not duplicate, add it
//                currentPathBuffer.Add(tileFromPath);
//            }

//            entityCommandBuffer.AddComponent(entity, new ReadyToMove { Destination = chosenTile });
//            entityCommandBuffer.RemoveComponent(entity, flagType);
//        }
//    }
...
//        if (reversedArray.IsCreated)
//            reversedArray.Dispose();
//    }

//    private NativeList<Entity> pathEntities;
//    private NativeArray<Entity> reversedArray;
...
//                {
//                    ReverseNativeEntityArray reverseNativeEntityArray = new ReverseNativeEntityArray
//                    {
//                        reverse = pathEntities,
//                    };

//                    JobHandle reverseJobHandle = reverseNativeEntityArray.Schedule(aStarPathfindingJobHandle);

//                    reverseJobHandle.Complete();

//                    DynamicBuffer<MapBuffer> currentPathBuffer = EntityManager.AddBuffer<MapBuffer>(pathfindingGroup[0]);

//                    PrepareEntityForMove prepareEntityForMove = new PrepareEntityForMove
//                    {
//                        chosenTile = EntityManager.GetComponentData<Tile>(pathfindingFlag.finalPositionEntity),
//                        currentPathBuffer = currentPathBuffer,
//                        entity = pathfindingGroup[0],
//                        entityCommandBuffer = endSimulationEntityCommandBufferSystem.CreateCommandBuffer(),
//                        moveToComponent = GetComponentDataFromEntity<MoveTo>(false),
//                        path = pathEntities,
//                        tileComponent = GetComponentDataFromEntity<Tile>(true),
//                        flagType = typeof(CalculatePathfindingFlag)
//                    };

//                    JobHandle prepareEntityToMoveHandle = prepareEntityForMove.Schedule(reverseJobHandle);

//                    inputDeps = JobHandle.CombineDependencies(inputDeps, prepareEntityToMoveHandle);
